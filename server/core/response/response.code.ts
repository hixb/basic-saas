...
export const ResponseMessage: Record<ResponseCodeType, string> = {
  ...
  [ResponseCode.INVALID_FORM_INPUT]: 'Invalid form input',
  [ResponseCode.SENSITIVE_CONTENT_DETECTED]: 'Sensitive content detected',
...
export const CodeToHttpStatus: Record<ResponseCodeType, number> = {
  ...
  [ResponseCode.INVALID_FORM_INPUT]: 422,
  [ResponseCode.SENSITIVE_CONTENT_DETECTED]: 422,
